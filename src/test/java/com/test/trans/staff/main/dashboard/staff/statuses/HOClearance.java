...
public class HOClearance {
    ...
    public void hoClearanceStat()throws InterruptedException{
        ...
        System.out.println("No of orders in HO clearance state: " + elementText);
        ...
        if (extractedNumber.isEmpty()) {
            ...
            System.out.println("Extracted no of orders in HO clearance state:" + extractedNumber);
        }
