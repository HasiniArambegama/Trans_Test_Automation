...
public class ReceivedByHOID {
    ...
    public void returnTOHOIDStat()throws InterruptedException{
        ...
        WebElement receivedByHOID = driver.findElement(By.xpath("/html/body/span/span/span/ul/li[19]"));
        receivedByHOID.click();
        ...
        WebElement dashReceivedByHOID = driver.findElement(By.xpath("//div[3]/div/div[2]/div[2]/div[1]/div/div[13]/div/div/div[1]/h3"));

        String ReceivedByHOIDOrders = dashReceivedByHOID.getText();

        System.out.println("Received by HO ID Stat:" + ReceivedByHOIDOrders);

        if(extractedNumber.equals(ReceivedByHOIDOrders)){
