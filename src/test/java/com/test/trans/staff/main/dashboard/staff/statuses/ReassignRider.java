...
public class ReassignRider {
    ...
    public void reAssignRiderStat()throws InterruptedException{
        ...
        WebElement rider = driver.findElement(By.xpath("/html/body/span/span/span/ul/li[21]"));
        rider.click();
        ...
        WebElement dashRiders = driver.findElement(By.xpath("//div[3]/div/div[2]/div[2]/div[1]/div/div[15]/div/div/div[1]/h3"));

        String reAssignRider = dashRiders.getText();

        System.out.println("Reassign rider Stat:" + reAssignRider);

        if(extractedNumber.equals(reAssignRider)){
